...
// 2️⃣ Updating (Component updates due to state/props changes)
...
// 4️⃣ Lifecycle Methods in Functional Components (useEffect Hook)
...
/// 2️⃣ Props Drilling (Passing Data Through Multiple Components)
// - Passing data from a parent component to a child component
// 📌 Solution: Context API (No need to pass props manually).

// 3️⃣ Context API (Global State)
// Method	Best For
